...
<head>
    ...
    <title>Mentor Bootstrap Template - home</title>
...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="home.php">EDUCATION</a></h1>
            <!-- Uncomment below if you prefer to use an image logo -->
            <!-- <a href="home.php" class="logo me-auto"><img src="assets/img/logo.png" alt="" class="img-fluid"></a>-->

            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    <li><a class="active" href="home.php">Home</a></li>
                    <li><a href="about.php">About</a></li>
                    <li><a href="quiz-online.php">Quiz online</a></li>
            ...
            <a href="quiz-online.php" class="get-started-btn">Get Started</a>
    ...
    <section id="hero" class="d-flex justify-content-center align-items-center">
        <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
            ...
            <a href="quiz-online.php" class="btn-get-started">Get Started</a>
        </div>
    </section>
    <!-- End Hero -->
